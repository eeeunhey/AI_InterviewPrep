        ...
        <ReactMarkdown
          ...
          components={{
            code({ node, className, children, ...props }) {
              ...
              const isInline = !className; // react-markdown에서 inline 은 className이 없음
  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between gap-3 px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        <button
          onClick={copyCode}
          className="flex items-center gap-1 text-xs px-2 py-1 rounded border border-gray-300 hover:bg-gray-200 transition"
